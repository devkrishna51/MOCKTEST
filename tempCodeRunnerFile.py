...
def quiz(subject, set_id):
    ...
    if request.method == 'POST':
        ...
        if not student_name or not student_age:
            # Show the form again
            return render_template('quiz_form.html', subject=subject, set_id=set_id,
                                   student_name=None, student_age=None, questions=questions)
...
def subject_page(subject_name):
    try:
        return render_template(f'subject_{subject_name}.html')
    except:
        return "Subject page not found", 404
